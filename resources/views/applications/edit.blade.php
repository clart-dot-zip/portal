            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="text-lg font-medium text-gray-900">Access Control Status</h3>
                        @if($accessSummary['access_type'] === 'public')
                    ...
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <p class="text-sm text-gray-700">{{ $accessSummary['message'] }}</p>
                            @if($accessSummary['access_type'] === 'restricted')
                                <p class="text-xs text-gray-500 mt-1">
                                    {{ $accessSummary['group_bindings'] }} group(s) and {{ $accessSummary['user_bindings'] }} individual user(s) have access
                                </p>
                            @endif
                        </div>
                    </div>
